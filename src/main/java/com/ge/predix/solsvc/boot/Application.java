...
public class Application
{
    ...
    {   StringBuffer requesturi = request.getRequestURL();
        ...
        model.addAttribute("compressionratio",applicationURl.toString()+"services/windservices/yearly_data/sensor_id/Letterkenny:watts");//$NON-NLS-1$
       // model.addAttribute("Knockroe:Feeder_LE17",applicationURl.toString()+"services/windservices/yearly_data/sensor_id/Knockroe:Feeder_LE17:watts");//$NON-NLS-1$ 
